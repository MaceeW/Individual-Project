    ...
    <section id="kickingjams" className="kickingjams-section">
      <div className="kickingjams-content">
        ...
        <div className="kickingjams-text">
          <h2>Kicking out<br />jams since ‘94</h2>
          <p>
          ...
          <Link to="/about" className="button-link">About Luna<br />Music</Link>
        </div>
      </div>
    </section>
  );
...
export default KickingJamsSection;
